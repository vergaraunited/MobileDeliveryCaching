...
{
    public class OrderOption : BaseData<OrderOption>, isaCacheItem<OrderOption>
    {
        ...
        public OrderOption(OrderOptionsData dt)
        {
        ...
        public OrderOptionsData OrderOptionsData()
        {
            return new OrderOptionsData()
            {
        ...
        public override int CompareTo(OrderOption other)
        {
